 ...
 * generated in the net.zhangwenbo.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://service.zhangwenbo.net/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://service.zhangwenbo.net/", "getValueResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.zhangwenbo.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.zhangwenbo.net/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.zhangwenbo.net/", name = "getValueResponse")
